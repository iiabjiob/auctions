Предлагаемый пайплайн
  ...
  Да. Я бы шел такими слайсами, каждый можно давать Codex отдельным промтом и закрывать PR/коммитом.
  ...
  Слайс 1: Lifecycle И Нормализованные Даты
  ...
  Слайс 2: Парсер Дат И Классификатор Актуальности
  ...
  Слайс 3: Интеграция Actuality В Sync
  ...
  Слайс 4: Default Grid Показывает Только Active
  ...
  Слайс 5: Actuality Sweep Worker
  ...
  Слайс 6: Top-N Enrichment Scheduler
  ...
  Слайс 7: SQL Priority В Enrichment Claim
  ...
  Слайс 8: Next Scan Window И Pipeline Status Для UI
  ...
  Слайс 9: Manual Refresh С Rate Limit
  ...
  Слайс 10: UI Видимость Актуальности
