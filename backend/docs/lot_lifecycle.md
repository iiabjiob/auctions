...
- a few `build_lot_analysis(...)` fallback reads that still rely on the legacy row/detail payload shape for category/exclusion/legal-risk heuristics and operational-readiness hints
